...
<body class="antialiased">
    <div class="relative flex items-top justify-center min-h-screen bg-base-100 sm:items-center py-4 sm:pt-0">
        @if (Route::has('login'))
            <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                ...
                @else
                    ...
                    @if (Route::has('register'))
                        <a href="{{ route('register') }}" class="ml-4 text-sm underline">Daftar</a>
                    @endif
                @endauth
            </div>
        @endif
        ...
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mt-8 bg-base-100 overflow-hidden shadow sm:rounded-lg">
